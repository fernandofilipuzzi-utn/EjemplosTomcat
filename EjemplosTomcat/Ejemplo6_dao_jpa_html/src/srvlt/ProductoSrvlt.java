...
import view.ProductoViewHtml;
import dao.IProductoDao;
import dao.ProductoDaoJpaImpl;

public class ProductoSrvlt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	final static IProductoDao productoDao=new ProductoDaoJpaImpl();
	ProductoViewHtml pv=new ProductoViewHtml();
		...
		try{
			...
			switch(comando){
				...
				case 6:{	
					...
					productoDao.modificar(modificado);
					pv.verListarProductos(response.getWriter(), productoDao.listarProductos());
				}break;
				case 7:{
					//elimina
			...
			e.printStackTrace();
			pv.verError(response.getWriter());
		}
